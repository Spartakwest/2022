...
function oblate(elem) {
  elem.textContent += '!';
}
function forEach(selector, func) {
  let elems = div15.querySelectorAll(selector);
...
function numberStart(elem, index) {
  elem.textContent = index + elem.textContent;
};

function forEach2(selector, func) {
  let elems = div16.querySelectorAll(selector);
